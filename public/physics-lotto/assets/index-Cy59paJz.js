...
void main() {
	...
	`}var cs=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new wi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Hu=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Uu=new io(-1,1,1,-1,0,1),Wu=new class extends Or{constructor(){super(),this.setAttribute(`position`,new q([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new q([0,2,0,0,2,0],2))}},Gu=class{constructor(e){this._mesh=new J(Wu,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Uu)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Ku=class extends Hu{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof ya?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=ga.clone(e.uniforms),this.material=new ya({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Gu(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},qu=class extends Hu{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Ju=class extends Hu{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Yu=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new H);this._width=n.width,this._height=n.height,t=new Jt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:v}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Ku(Vu),this.copyPass.material.blending=0,this.timer=new fo}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}qu!==void 0&&(r instanceof qu?n=!0:r instanceof Ju&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new H);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Xu=class extends Hu{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new K}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Zu={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new K(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Qu.BlurDirectionX=new H(1,0),Qu.BlurDirectionY=new H(0,1);var $u={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},ed=class extends Hu{constructor(){super(),this.isOutputPass=!0,this.uniforms=ga.clone($u.uniforms),this.material=new ba({name:$u.name,uniforms:this.uniforms,vertexShader:$u.vertexShader,fragmentShader:$u.fragmentShader}),this._fsQuad=new Gu(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},G.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},td={R:1,H:2,baseY:.55},nd=.175,rd=[`#f4b400`,`#3b9fe8`,`#ef5350`,`#8b919c`,`#7cc02a`];function id(e,t){switch(t){case`korea`:return{base:rd[Math.min(4,Math.floor((e-1)/10))],patch:`#efefef`,text:`#0b0b0b`,ring:null};case`red`:return{base:`#d3242b`,patch:null,text:`#ffffff`,ring:null};case`blue`:return{base:`#1e63d0`,patch:null,text:`#ffffff`,ring:null};case`gold`:return{base:`#d9a51f`,patch:null,text:`#1a1a1a`,ring:null};case`green`:return{base:`#2f9e5b`,patch:null,text:`#ffffff`,ring:null};default:return{base:`#e6e1d6`,patch:null,text:`#111111`,ring:`#2a2a2a`}}}var ad=new Map;function od(e,t){let r=t+`:`+e;if(ad.has(r))return ad.get(r);let i=id(e,t),a=1024,o=document.createElement(`canvas`);o.width=a,o.height=512;let s=o.getContext(`2d`);s.fillStyle=i.base,s.fillRect(0,0,a,512);let c=s.createLinearGradient(0,0,0,512);c.addColorStop(0,`rgba(255,255,255,0.05)`),c.addColorStop(.5,`rgba(255,255,255,0)`),c.addColorStop(1,`rgba(0,0,0,0.12)`),s.fillStyle=c,s.fillRect(0,0,a,512);let l=String(e),u=[];for(let e=0;e<4;e++)u.push({u:e/4,lat:0});for(let e=0;e<4;e++)u.push({u:(e+.5)/4,lat:46});for(let e=0;e<4;e++)u.push({u:(e+.5)/4,lat:-46});for(let e of u){let t=e.u*a,n=256-e.lat/180*512,r=1/Math.cos(Ot.degToRad(e.lat));s.save(),s.translate(t,n),s.scale(r,1),i.patch?(s.beginPath(),s.arc(0,0,64,0,Math.PI*2),s.fillStyle=i.patch,s.fill()):i.ring&&(s.beginPath(),s.arc(0,0,64,0,Math.PI*2),s.lineWidth=5,s.strokeStyle=i.ring,s.stroke()),s.fillStyle=i.text,s.textAlign=`center`,s.textBaseline=`middle`;let o=l.length>1?92:104;s.font=`900 ${o}px "Arial Black", "Helvetica Neue", Arial, sans-serif`,s.fillText(l,0,6),s.restore(),e.u===0&&(s.save(),s.translate(a,n),i.patch?(s.beginPath(),s.arc(0,0,64,0,Math.PI*2),s.fillStyle=i.patch,s.fill()):i.ring&&(s.beginPath(),s.arc(0,0,64,0,Math.PI*2),s.lineWidth=5,s.strokeStyle=i.ring,s.stroke()),s.fillStyle=i.text,s.textAlign=`center`,s.textBaseline=`middle`,s.font=`900 ${o}px "Arial Black", "Helvetica Neue", Arial, sans-serif`,s.fillText(l,0,6),s.restore())}let d=new Ti(o);return d.colorSpace=ze,d.anisotropy=8,d.wrapS=n,ad.set(r,d),d}var sd=new Map;function cd(e){let t=e.toFixed(4);return sd.has(t)||sd.set(t,new ca(e,40,28)),sd.get(t)}function ld(e,t,n){let r=new Sa({map:od(e,t),roughness:.66,metalness:0,clearcoat:.18,clearcoatRoughness:.6,envMapIntensity:.38}),i=new J(cd(n),r);return i.castShadow=!0,i.receiveShadow=!1,i}function ud(e){let t=new Kl({antialias:!0,alpha:!1,powerPreference:`high-performance`});t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.setSize(e.clientWidth,e.clientHeight),t.shadowMap.enabled=!0,t.shadowMap.type=2,t.toneMapping=4,t.toneMappingExposure=.86,e.appendChild(t.domElement);let n=new Fn;n.background=new K(`#0b0f1a`),n.fog=new Pn(`#0b0f1a`,14,26);let r=new $a(42,e.clientWidth/e.clientHeight,.1,60);r.position.set(.6,2.45,7.5);let i=new Eu(r,t.domElement);i.target.set(0,1.28,.4),i.enableDamping=!0,i.dampingFactor=.06,i.minDistance=4,i.maxDistance=12,i.minPolarAngle=.35,i.maxPolarAngle=Math.PI/2-.02,i.enablePan=!1,i.update(),n.environment=new $o(t).fromScene(new zu,.04).texture,n.environmentIntensity=.6;let a=new Va(`#cfe3ff`,`#20242e`,.35);n.add(a);let o=new oo(`#fff4e0`,1.6);o.position.set(3.5,7,4.5),o.castShadow=!0,o.shadow.mapSize.set(2048,2048),o.shadow.camera.near=1,o.shadow.camera.far=20,o.shadow.camera.left=-4,o.shadow.camera.right=4,o.shadow.camera.top=5,o.shadow.camera.bottom=-2,o.shadow.bias=-6e-4,o.shadow.normalBias=.02,n.add(o);let s=new oo(`#7fb0ff`,1.1);s.position.set(-5,4,-4),n.add(s);let c=new ro(`#ffd9a8`,6,12,2);c.position.set(-2.5,3.2,3.5),n.add(c);let l=new xa({color:`#141924`,roughness:.55,metalness:.35,envMapIntensity:.6}),u=new J(new Ai(14,64),l);u.rotation.x=-Math.PI/2,u.receiveShadow=!0,n.add(u);let d=new J(new sa(1.35,1.42,96),new zr({color:`#3d7bff`,transparent:!0,opacity:.35,side:2}));d.rotation.x=-Math.PI/2,d.position.y=.002,n.add(d);let f=new xa({color:`#262a33`,roughness:.62,metalness:.45,envMapIntensity:.55}),p=new xa({color:`#9aa3b2`,roughness:.48,metalness:.7,envMapIntensity:.55}),{R:m,H:h,baseY:g}=td,_=new En,v=g-.08,y=new J(new aa([new H(m-.02,0),new H(m+.4,0),new H(m+.28,v),new H(m-.02,v),new H(m-.02,0)],96),f);y.castShadow=!0,y.receiveShadow=!0,_.add(y);let b=new J(new aa([new H(m-.02,0),new H(m+.28,0),new H(m+.12,.08),new H(m-.02,.08),new H(m-.02,0)],96),p);b.position.y=g-.08,b.castShadow=!0,_.add(b);let x=new J(new ji(m-.02,m-.02,g-.01,64,1,!0),new xa({color:`#04060b`,roughness:.95,metalness:0,side:1}));x.position.y=(g-.01)/2,_.add(x);let S=new J(new Ai(m-.02,64),new xa({color:`#04060b`,roughness:.95}));S.rotation.x=-Math.PI/2,S.position.y=.01,_.add(S);let C=new xa({color:`#0a1a33`,emissive:`#3d7bff`,emissiveIntensity:1.2,roughness:.4}),w=new J(new la(m+.31,.018,12,128),C);w.rotation.x=Math.PI/2,w.position.y=g-.1,_.add(w),n.add(_);let T=new En;T.position.y=g,n.add(T);let E=new Sa({color:`#ffffff`,metalness:0,roughness:.02,transmission:1,thickness:.04,ior:1.45,clearcoat:1,clearcoatRoughness:.03,envMapIntensity:1.2,side:0,attenuationColor:new K(`#dfeeff`),attenuationDistance:3.5,specularIntensity:1,depthWrite:!1}),D=new J(new ji(m+.03,m+.03,h,128,1,!0),E);D.position.y=h/2,T.add(D);let O=new J(new ji(m+.005,m+.005,h,128,1,!0),new Sa({color:`#dfeeff`,transparent:!0,opacity:.08,roughness:.05,metalness:0,side:1,depthWrite:!1}));O.position.y=h/2,T.add(O);let k=new xa({map:(()=>{let e=document.createElement(`canvas`);e.width=512,e.height=512;let t=e.getContext(`2d`);t.fillStyle=`#1b1f28`,t.fillRect(0,0,512,512),t.strokeStyle=`#3a4150`,t.lineWidth=3;for(let e=40;e<256;e+=26)t.beginPath(),t.arc(256,256,e,0,Math.PI*2),t.stroke();t.strokeStyle=`#2b303b`,t.lineWidth=2;for(let e=0;e<24;e++)t.beginPath(),t.moveTo(256,256),t.lineTo(256+Math.cos(e/24*6.283)*256,256+Math.sin(e/24*6.283)*256),t.stroke();let n=new Ti(e);return n.colorSpace=ze,n})(),color:`#ffffff`,roughness:.6,metalness:.5}),A=[];for(let e=0;e<2;e++){let t=new En,n=new J(new Ai(m+.02,64,e===0?Math.PI/2:-Math.PI/2,Math.PI),k);n.rotation.x=-Math.PI/2,n.receiveShadow=!0;let r=e===0?-1:1;t.position.set(r*m,.005,0),n.position.set(-r*m,0,0),n.rotation.z=0,t.add(n),T.add(t),A.push({pivot:t,sign:r})}let j=new xa({color:`#0d1b33`,emissive:`#4da3ff`,emissiveIntensity:0,roughness:.3,metalness:.6}),ee=new J(new ji(.16,.22,.05,48),p);ee.position.y=.025,T.add(ee);let M=new J(new ji(.11,.11,.02,48),j);M.position.y=.055,T.add(M);let te=new J(new ji(.13,.15,g,32),f);te.position.y=-g/2,T.add(te);function ne(e,t){let n=new J(new aa([new H(m-.02,0),new H(m+.09,0),new H(m+.11,.03),new H(m+.11,.09),new H(m+.09,.12),new H(m-.02,.12)],128),p);return n.position.y=e,t&&(n.scale.y=-1),n.castShadow=!0,n}T.add(ne(0,!1)),T.add(ne(h,!0));let N=.2,re=new En;T.add(re);let ie=null,ae=null,oe=null,se=null,ce=new xa({color:`#f0f3f8`,roughness:.25,metalness:.9,emissive:`#000000`}),le={holeR:N,gateOpen:0,wind:0,trapOpen:0,tubeCurve:null};function P(e){for(le.holeR=e;re.children.length;)re.remove(re.children[0]);ie=new J(new aa([new H(e+.005,-.01),new H(e+.06,0),new H(m-.02,0),new H(m-.02,.06),new H(e+.12,.06),new H(e+.06,.16),new H(e+.005,.16)],128),f),ie.position.y=h,ie.castShadow=!0,re.add(ie),ae=new J(new ji(e+.03,e+.03,.02,48),ce),ae.position.y=h+.17,re.add(ae),oe=new J(new la(e+.075,.012,10,64),new xa({color:`#111`,emissive:`#ff3b3b`,emissiveIntensity:1.5,roughness:.4})),oe.rotation.x=Math.PI/2,oe.position.y=h+.165,re.add(oe);let t=new Vi([new U(0,h+0,0),new U(0,h+.42,0),new U(.22,h+.68,.32),new U(.95,h+.62,.98),new U(1.6,h+.2,1.5),new U(1.9,h-.6,1.72),new U(2,ue-g+.02,de)],!1,`catmullrom`,.5);le.tubeCurve=t,se=new J(new ua(t,96,e+.03,32,!1),new Sa({color:`#ffffff`,metalness:0,roughness:.06,transmission:1,thickness:.03,ior:1.4,clearcoat:1,clearcoatRoughness:.05,envMapIntensity:.9,attenuationColor:new K(`#cfe4ff`),attenuationDistance:1.2,side:0})),se.renderOrder=5,re.add(se);let n=new J(new ji(e+.07,e+.07,.12,48,1,!0),p);n.position.y=h+.22,re.add(n)}let ue=.62,de=1.9,fe=new En;n.add(fe);let pe=4.6,me=new J(new ki(pe,.08,.34),f);me.position.set(0,.51,de),me.castShadow=!0,me.receiveShadow=!0,fe.add(me);let he=new J(new ki(pe,.02,.36),p);he.position.set(0,.5549999999999999,de),fe.add(he);for(let e of[-1,1]){let t=new J(new ji(.02,.02,pe,16),p);t.rotation.z=Math.PI/2,t.position.set(0,.575,de+e*.13),fe.add(t)}for(let e of[-1.9,0,1.9]){let t=new J(new ki(.08,.47,.2),f);t.position.set(e,.47/2,de),t.castShadow=!0,fe.add(t)}let ge=new J(new ki(4.5,.012,.012),C);ge.position.set(0,.47,2.08),fe.add(ge);let _e=new to(`#fff6e8`,7,9,.62,.7,1.4);_e.position.set(0,4.2,3.5),_e.target.position.set(0,ue,de),n.add(_e),n.add(_e.target);let ve=new En;n.add(ve);let ye=[];function be(e){for(;ve.children.length;)ve.remove(ve.children[0]);ye.length=0;for(let t of e){let e=new J(new sa(nd*.55,nd*.75,48),new zr({color:`#4d8bff`,transparent:!0,opacity:.22,side:2,depthWrite:!1}));e.rotation.x=-Math.PI/2,e.position.set(t.x,.568,t.z),ve.add(e),ye.push(e)}}function xe(e,t){let n=ye[e];n&&(n.material.color.set(t?`#7ec8ff`:`#4d8bff`),n.material.opacity=t?.9:.22,n.scale.setScalar(t?1.9:1))}P(N);let Se=new Float32Array(1080),Ce=new Float32Array(360),we=new Or;we.setAttribute(`position`,new mr(Se,3));let Te=new _i({size:.05,map:(()=>{let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,0,32,32,32);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.35,`rgba(255,255,255,0.45)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),new Ti(e)})(),transparent:!0,opacity:0,color:`#bfe0ff`,depthWrite:!1,blending:2,sizeAttenuation:!0}),Ee=new Si(we,Te);Ee.frustumCulled=!1,T.add(Ee);function De(e,t){let n=Math.random()*Math.PI*2,r=Math.sqrt(Math.random())*.28;Se[e*3]=Math.cos(n)*r,Se[e*3+1]=t?Math.random()*h:.05+Math.random()*.1,Se[e*3+2]=Math.sin(n)*r,Ce[e]=.8+Math.random()*1.6}for(let e=0;e<360;e++)De(e,!0);let Oe=new U,ke=null;function Ae(e){let t=le.wind;if(Te.opacity=Ot.lerp(Te.opacity,t*.6,1-Math.exp(-e*3)),!(Te.opacity<.01||!ke)){for(let t=0;t<360;t++){let n=t*3;ke(Se[n],Se[n+1],Se[n+2],Oe);let r=2.6;Se[n]+=(Oe.x*r+(Math.random()-.5)*.4)*e,Se[n+1]+=(Oe.y*r+.15)*e,Se[n+2]+=(Oe.z*r+(Math.random()-.5)*.4)*e,Ce[t]-=e;let i=Math.hypot(Se[n],Se[n+2]);(Ce[t]<=0||Se[n+1]>h-.02||Se[n+1]<0||i>m-.02)&&De(t,!1)}we.attributes.position.needsUpdate=!0}}let je=new Yu(t);je.addPass(new Xu(n,r));let Me=new Qu(new H(e.clientWidth,e.clientHeight),.12,.4,1.9);je.addPass(Me),je.addPass(new ed);function Ne(){let n=e.clientWidth,a=e.clientHeight,o=n/a;t.setPixelRatio(Math.min(window.devicePixelRatio,n<900?1.5:2)),t.setSize(n,a),je.setSize(n,a),r.aspect=o,o>=1.8?r.fov=Ot.clamp(1.78/o*42,33,42):o>=1.3?r.fov=42:r.fov=Ot.clamp(42*(1.3/o)**.55,42,72),r.updateProjectionMatrix(),i.target.y=o>=1.3?1.28:Ot.lerp(1.28,1.05,Ot.clamp((1.3-o)/.8,0,1))}Ne(),window.addEventListener(`resize`,Ne);let F=0;function Pe(e){if(F+=e,i.update(),ae){let t=le.gateOpen;ae.position.x=Ot.lerp(ae.position.x,t*(le.holeR*2+.08),1-Math.exp(-e*12)),oe.material.emissive.set(t?`#39ff8a`:`#ff3b3b`)}j.emissiveIntensity=Ot.lerp(j.emissiveIntensity,le.wind*2.5,1-Math.exp(-e*4)),C.emissiveIntensity=.9+le.wind*1+Math.sin(F*3)*.15*le.wind;for(let t of A){let n=le.trapOpen?t.sign*1.35:0;t.pivot.rotation.z=Ot.lerp(t.pivot.rotation.z,n,1-Math.exp(-e*6))}Ae(e)}function Fe(){je.render()}return{renderer:t,scene:n,camera:r,controls:i,drum:T,state:le,buildCap:P,update:Pe,render:Fe,resize:Ne,bloom:Me,composer:je,setWindSampler(e){ke=e},RAIL_Y:ue,RAIL_Z:de,railLen:pe,slotPos(e,t){let n=Math.min(.42,3.8999999999999995/Math.max(1,t-1));return new U(-(n*(t-1))/2+e*n,.7399999999999999,de)},setSlots:be,lightSlot:xe}}var dd=class{constructor(){this.ctx=null,this.enabled=!0,this.master=null,this.airGain=null,this.lastClick=0,this.clickCount=0}init(){if(this.ctx)return;let e=window.AudioContext||window.webkitAudioContext;if(!e)return;let t=this.ctx=new e;this.master=t.createGain(),this.master.gain.value=.9,this.master.connect(t.destination);let n=t.sampleRate*2,r=t.createBuffer(1,n,t.sampleRate),i=r.getChannelData(0),a=0,o=0,s=0;for(let e=0;e<n;e++){let t=Math.random()*2-1;a=.99765*a+t*.099046,o=.963*o+t*.2965164,s=.57*s+t*1.0526913,i[e]=(a+o+s+t*.1848)*.11}this.noiseBuf=r;let c=t.createBufferSource();c.buffer=r,c.loop=!0;let l=t.createBiquadFilter();l.type=`lowpass`,l.frequency.value=900,l.Q.value=.7,this.airFilter=l,this.airGain=t.createGain(),this.airGain.gain.value=0,c.connect(l).connect(this.airGain).connect(this.master),c.start();let u=Math.floor(t.sampleRate*.12),d=t.createBuffer(1,u,t.sampleRate),f=d.getChannelData(0);for(let e=0;e<u;e++)f[e]=Math.random()*2-1;this.clickBuf=d}resume(){this.ctx&&this.ctx.state===`suspended`&&this.ctx.resume()}setEnabled(e){this.enabled=e,this.master&&this.master.gain.setTargetAtTime(e?.9:0,this.ctx.currentTime,.05)}setAir(e){if(!this.airGain)return;let t=this.ctx.currentTime;this.airGain.gain.setTargetAtTime(e*.55,t,.15),this.airFilter.frequency.setTargetAtTime(500+e*1400,t,.2)}click(e,t=`ball`){if(!this.ctx||!this.enabled)return;let n=performance.now();if(n-this.lastClick<18)return;this.lastClick=n;let r=this.ctx,i=r.currentTime,a=Math.min(1,(e-.6)/6)*(t===`ball`?.5:.35);if(a<=.01)return;let o=r.createBufferSource();o.buffer=this.clickBuf;let s=r.createBiquadFilter();s.type=`bandpass`,s.frequency.value=t===`ball`?2600+Math.random()*1400:900+Math.random()*500,s.Q.value=t===`ball`?3.5:1.8;let c=r.createGain();c.gain.setValueAtTime(a,i),c.gain.exponentialRampToValueAtTime(.001,i+(t===`ball`?.05:.09)),o.connect(s).connect(c).connect(this.master),o.start(i),o.stop(i+.12)}gate(){if(!this.ctx||!this.enabled)return;let e=this.ctx,t=e.currentTime,n=e.createOscillator();n.type=`square`,n.frequency.setValueAtTime(180,t),n.frequency.exponentialRampToValueAtTime(90,t+.08);let r=e.createGain();r.gain.setValueAtTime(.12,t),r.gain.exponentialRampToValueAtTime(.001,t+.1),n.connect(r).connect(this.master),n.start(t),n.stop(t+.12)}whoosh(){if(!this.ctx||!this.enabled)return;let e=this.ctx,t=e.currentTime,n=e.createBufferSource();n.buffer=this.noiseBuf;let r=e.createBiquadFilter();r.type=`bandpass`,r.Q.value=1.2,r.frequency.setValueAtTime(400,t),r.frequency.exponentialRampToValueAtTime(2600,t+.35),r.frequency.exponentialRampToValueAtTime(600,t+.8);let i=e.createGain();i.gain.setValueAtTime(1e-4,t),i.gain.exponentialRampToValueAtTime(.9,t+.15),i.gain.exponentialRampToValueAtTime(.001,t+.85),n.connect(r).connect(i).connect(this.master),n.start(t),n.stop(t+.9)}land(e=0){if(!this.ctx||!this.enabled)return;let t=this.ctx,n=t.currentTime;this.click(5,`wall`);let r=660*2**(e%7/12);for(let[e,i]of[[1,.16],[2,.05],[3,.02]]){let a=t.createOscillator();a.type=`sine`,a.frequency.value=r*e;let o=t.createGain();o.gain.setValueAtTime(i,n+.02),o.gain.exponentialRampToValueAtTime(.001,n+.9),a.connect(o).connect(this.master),a.start(n+.02),a.stop(n+1)}}fanfare(){if(!this.ctx||!this.enabled)return;let e=this.ctx,t=e.currentTime,n=[523.25,659.25,783.99,1046.5];n.forEach((r,i)=>{let a=t+i*.11,o=e.createOscillator();o.type=`triangle`,o.frequency.value=r;let s=e.createGain();s.gain.setValueAtTime(1e-4,a),s.gain.exponentialRampToValueAtTime(.18,a+.02),s.gain.exponentialRampToValueAtTime(.001,a+(i===n.length-1?1.4:.35)),o.connect(s).connect(this.master),o.start(a),o.stop(a+1.5)})}},fd=`2026-09-26 02:08 UTC`;console.info(`[Physics Lotto] build`,fd);function pd(){let e=window.innerWidth,t=window.innerHeight,n=e<=720||t>e,r=e>t&&t<=520,i=document.body.classList;i.toggle(`compact`,n&&!r),i.toggle(`compact-sm`,n&&!r&&e<=420),i.toggle(`compact-xs`,n&&!r&&e<=360),i.toggle(`land-short`,r)}pd(),window.addEventListener(`resize`,pd),window.addEventListener(`orientationchange`,pd);var md=ud(document.getElementById(`app`)),Z=new hu({radius:td.R,height:td.H,holeRadius:.2}),hd=new dd,Q={loading:document.getElementById(`loading`),select:document.getElementById(`gameSelect`),info:document.getElementById(`gameInfo`),status:document.getElementById(`status`),results:document.getElementById(`results`),summary:document.getElementById(`summary`),btnDraw:document.getElementById(`btnDraw`),btnReset:document.getElementById(`btnReset`),btnSpeed:document.getElementById(`btnSpeed`),btnSound:document.getElementById(`btnSound`),langSelect:document.getElementById(`langSelect`),btnHistory:document.getElementById(`btnHistory`),histBadge:document.getElementById(`histBadge`),histPanel:document.getElementById(`historyPanel`),histTitle:document.getElementById(`histTitle`),histList:document.getElementById(`histList`),btnSavePng:document.getElementById(`btnSavePng`),histBackdrop:document.getElementById(`histBackdrop`),btnHistClose:document.getElementById(`btnHistClose`),histCoach:document.getElementById(`histCoach`),histCoachText:document.getElementById(`histCoachText`)},$={game:null,stages:[],results:[],running:!1,runId:0,timeScale:1,soundOn:!0,slotR:.13,totalSlots:0,railBalls:[],swapping:!1,drawDone:!1};function gd(e){return Ot.clamp(.8/Math.sqrt(e),.086,.15)}function _d(e){return e*1.42+.01}var vd=[];function yd(e){return new Promise(t=>vd.push({t:e,res:t}))}function bd(e){for(let t=vd.length-1;t>=0;t--)if(vd[t].t-=e,vd[t].t<=0){let{res:e}=vd[t];vd.splice(t,1),e()}}var xd=[];function Sd(e,t,n=e=>e){return new Promise(r=>xd.push({t:0,d:e,onUpdate:t,ease:n,res:r}))}function Cd(e){for(let t=xd.length-1;t>=0;t--){let n=xd[t];n.t+=e;let r=Math.min(1,n.t/n.d);n.onUpdate(n.ease(r),r),r>=1&&(xd.splice(t,1),n.res())}}var wd=e=>-(Math.cos(Math.PI*e)-1)/2,Td=e=>1-(1-e)**3,Ed=e=>e*e,Dd=null;function Od(e,t={},n=``){Dd={key:e,vars:t,cls:n},Q.status.textContent=nu(e,t),Q.status.className=`status `+n}function kd(){return`${$.game.flag} ${$.game.name}`}function Ad(){document.querySelectorAll(`[data-i18n]`).forEach(e=>{e.textContent=nu(e.dataset.i18n)}),document.title=nu(`docTitle`),Q.btnDraw.textContent=nu($.drawDone?`again`:`start`)}function jd(e,t=!0){let n=gd(e.max-e.min+1);Z.holeR=_d(n),md.buildCap(Z.holeR);let r=[];for(let t=e.min;t<=e.max;t++){let i=new mu(`${e.scheme}-${t}`,t,n);i.mesh=ld(t,e.scheme,n),md.drum.add(i.mesh),Z.addBall(i),r.push(i)}if(Z.scatter(r,n+.05,td.H-n-.05),t)for(let e of r)e.mesh.scale.setScalar(.001),yd(Math.random()*.35).then(()=>Sd(.35,t=>e.mesh.scale.setScalar(t),Td));return r}function Md(e){e.mesh&&=(e.mesh.parent&&e.mesh.parent.remove(e.mesh),e.mesh.material.dispose(),null)}async function Nd(e=!0){let t=Z.balls.slice();Z.clear(),e&&await Sd(.3,e=>{for(let n of t)n.mesh&&n.mesh.scale.setScalar(1-e)},Ed);for(let e of t)Md(e)}async function Pd(e=!0){let t=$.railBalls.slice();$.railBalls.length=0,e&&t.length&&await Sd(.35,e=>{for(let n of t)n.scale.setScalar(1-e),n.position.y+=.02*(1-e)},Ed);for(let e of t)e.parent&&e.parent.remove(e),e.material.dispose()}function Fd(){let e=[[`regionAsia`,[`KR`,`JP`,`CN`,`TW`,`HK`,`SG`,`VN`,`PH`,`MY`,`IL`,`TR`,`RU`]],[`regionAmericas`,[`US`,`CA`,`MX`,`BR`]],[`regionEurope`,[`EU`,`GB`,`IE`,`DE`,`FR`,`ES`,`IT`,`NL`,`BE`,`CH`,`AT`,`PL`,`SE`,`PT`,`GR`]],[`regionOceania`,[`AU`,`NZ`,`ZA`]]],t=Q.select.value;Q.select.innerHTML=``;for(let[t,n]of e){let e=document.createElement(`optgroup`);e.label=nu(t);for(let t of n)for(let n of ql.filter(e=>e.country===t)){let t=document.createElement(`option`);t.value=n.id,t.textContent=`${n.flag} ${au(n.country)} · ${n.name}`,e.appendChild(t)}Q.select.appendChild(e)}t&&(Q.select.value=t)}function Id(){Q.langSelect.innerHTML=``;for(let[e,t]of Object.entries(Xl)){let n=document.createElement(`option`);n.value=e,n.textContent=t.name,Q.langSelect.appendChild(n)}Q.langSelect.value=tu()}function Ld(){Ad(),Fd(),$.game&&(Rd($.game),Q.results.querySelectorAll(`.group-label`).forEach((e,t)=>{e.textContent=ru($.stages[t].label)}),Hd()),Dd&&Od(Dd.key,Dd.vars,Dd.cls),Qd()}function Rd(e){let t=[`<b>${nu(`pick`,{n:e.main.pick})}</b> / ${nu(`range`,{a:e.main.min,b:e.main.max})}`];for(let n of e.extras)n.sameDrum?t.push(`+ ${ru(n.label)} <b>${nu(`pick`,{n:n.pick})}</b> (${nu(`sameDrum`)})`):t.push(`+ ${ru(n.label)} <b>${nu(`pick`,{n:n.pick})}</b> / ${nu(`range`,{a:n.min,b:n.max})} (${nu(`separateDrum`)})`);Q.info.innerHTML=`<span class="gi-line">${e.operator}</span><span class="gi-line">${t.join(` `)}</span><span class="gi-line gi-dim">${nu(`schedule`)}: ${su(e.draw)}</span>`}function zd(){if(!$.stages.length)return;let e=$.totalSlots,t=$.stages.length,n=t-1,r=window.innerWidth<=420?5:6,i=Math.min(window.innerWidth,1100)-44,a=Math.floor((i-(e-t)*r-n*18)/e),o=window.innerWidth>720?56:42;a=Math.max(24,Math.min(o,a)),Q.results.style.setProperty(`--chip`,a+`px`)}function Bd(){Q.results.innerHTML=``,Q.summary.textContent=``,$.stages.forEach((e,t)=>{if(t>0){let e=document.createElement(`div`);e.className=`sep`,Q.results.appendChild(e)}let n=document.createElement(`div`);n.className=`group`;let r=document.createElement(`div`);r.className=`group-label`,r.textContent=ru(e.label);let i=document.createElement(`div`);i.className=`row`;for(let n=0;n<e.pick;n++){let e=document.createElement(`div`);e.className=`chip`,e.dataset.stage=t,e.dataset.k=n,e.textContent=`·`,i.appendChild(e)}n.appendChild(r),n.appendChild(i),Q.results.appendChild(n)}),zd()}function Vd(e,t,n,r){let i=Q.results.querySelector(`.chip[data-stage="${e}"][data-k="${t}"]`);if(!i)return;let a=id(n,r);i.classList.add(`filled`),i.style.background=a.base,a.text===`#ffffff`&&i.classList.add(`light`),i.textContent=String(n),Hd()}function Hd(){$.game;let e=$.stages.map((e,t)=>$.results.filter(e=>e.stageIndex===t).map(e=>e.num));if(!e[0].length){Q.summary.textContent=``;return}let t=[`${nu(`sorted`)} <b>${e[0].slice().sort((e,t)=>e-t).join(` · `)}</b>`];for(let n=1;n<e.length;n++)e[n].length&&t.push(`${ru($.stages[n].label)} <b>${e[n].join(` · `)}</b>`);Q.summary.innerHTML=t.join(` &nbsp;|&nbsp; `)}var Ud=`physics-lotto-history`,Wd=20,Gd=[];try{Gd=JSON.parse(localStorage.getItem(Ud)||`[]`)}catch{Gd=[]}function Kd(){try{localStorage.setItem(Ud,JSON.stringify(Gd))}catch{}}function qd(){let e=$.stages.map((e,t)=>{let n=$.results.filter(e=>e.stageIndex===t).map(e=>e.num);return{label:ru(e.label),scheme:e.scheme,nums:e.isMain?n.slice().sort((e,t)=>e-t):n}}).filter(e=>e.nums.length);Gd.unshift({id:Date.now(),flag:$.game.flag,name:$.game.name,date:Date.now(),groups:e}),Gd.length>Wd&&(Gd.length=Wd),Kd(),Qd(),Q.histBadge.classList.remove(`pulse`),Q.histBadge.offsetWidth,Q.histBadge.classList.add(`pulse`),Zd()}var Jd=`physics-lotto-hist-coach`,Yd=null;function Xd(){Q.histCoach.hidden=!0,Yd&&=(clearTimeout(Yd),null)}function Zd(){let e=null;try{e=localStorage.getItem(Jd)}catch{}if(e)return;try{localStorage.setItem(Jd,`1`)}catch{}Q.histCoachText.textContent=nu(`historyHint`),Q.histCoach.hidden=!1;let t=Q.btnHistory.getBoundingClientRect(),n=Q.histCoach.getBoundingClientRect(),r=Math.max(10,Math.min(window.innerWidth-n.width-10,t.left+t.width/2-n.width/2));Q.histCoach.style.left=r+`px`,Q.histCoach.style.top=t.top-n.height-12+`px`,Q.histCoach.style.setProperty(`--arrow-x`,t.left+t.width/2-r+`px`),Yd=setTimeout(Xd,8e3)}function Qd(){Q.histTitle.textContent=`${nu(`history`)} (${Gd.length})`,Q.btnSavePng.textContent=nu(`savePng`),Q.btnSavePng.disabled=Gd.length===0,Q.histBadge.hidden=Gd.length===0,Q.histBadge.textContent=String(Gd.length),Q.histList.innerHTML=``;for(let e of Gd){let t=document.createElement(`li`),n=document.createElement(`span`);n.className=`h-flag`,n.textContent=e.flag;let r=document.createElement(`span`);r.className=`h-nums`,e.groups.forEach((e,t)=>{if(t>0){let e=document.createElement(`span`);e.className=`hsep`,r.appendChild(e)}for(let t of e.nums){let n=document.createElement(`span`);n.className=`hnum`;let i=id(t,e.scheme);n.style.background=i.base,i.text===`#ffffff`&&n.classList.add(`light`),n.textContent=String(t),r.appendChild(n)}});let i=document.createElement(`button`);i.className=`h-del`,i.textContent=`🗑`,i.title=`delete`,i.addEventListener(`click`,()=>{Gd=Gd.filter(t=>t.id!==e.id),Kd(),Qd(),Gd.length||(Q.histPanel.hidden=!0,Q.histBackdrop.hidden=!0)}),t.appendChild(n),t.appendChild(r),t.appendChild(i),Q.histList.appendChild(t)}}async function $d(){if(!Gd.length)return;let e=1080,t=262+Gd.length*118,n=document.createElement(`canvas`);n.width=e,n.height=t;let r=n.getContext(`2d`),i=r.createLinearGradient(0,0,0,t);i.addColorStop(0,`#0d1220`),i.addColorStop(1,`#0a0e18`),r.fillStyle=i,r.fillRect(0,0,e,t),r.fillStyle=`#eef2fb`,r.textBaseline=`middle`,r.font=`800 46px -apple-system, "Apple SD Gothic Neo", "Segoe UI", sans-serif`,r.fillText(`🎱 Physics Lotto`,56,86),r.fillStyle=`#98a3bd`,r.font=`400 26px -apple-system, "Apple SD Gothic Neo", "Segoe UI", sans-serif`;let a=new Intl.DateTimeFormat(tu(),{dateStyle:`medium`,timeStyle:`short`}).format(new Date);r.fillText(a,56,140),r.strokeStyle=`rgba(255,255,255,0.12)`,r.lineWidth=2,r.beginPath(),r.moveTo(56,178),r.lineTo(1024,178),r.stroke(),Gd.forEach((e,t)=>{let n=206+t*118+59;r.font=`400 34px -apple-system, "Segoe UI", sans-serif`,r.fillText(e.flag,56,n);let i=126;for(let t of e.groups){for(let e of t.nums){let a=id(e,t.scheme),o=r.createRadialGradient(i+9.45,n-10.8,5.4,i+13.5,n+5.4,40.5);o.addColorStop(0,`#ffffff`),o.addColorStop(.25,a.base),o.addColorStop(1,a.base),r.beginPath(),r.arc(i+27,n,27,0,Math.PI*2),r.fillStyle=a.base,r.fill(),r.beginPath(),r.arc(i+27,n,27,0,Math.PI*2),r.fillStyle=`rgba(255,255,255,0.14)`,r.fill(),r.beginPath(),r.arc(i+27,n,26,0,Math.PI*2),r.fillStyle=a.base,r.fill(),r.fillStyle=a.text,r.font=`800 26px -apple-system, "Segoe UI", sans-serif`,r.textAlign=`center`,r.fillText(String(e),i+27,n+1),r.textAlign=`left`,i+=64}i+=16}}),r.fillStyle=`rgba(152,163,189,0.6)`,r.font=`400 22px -apple-system, "Segoe UI", sans-serif`,r.fillText(`physics-lotto`,56,t-28);let o=await new Promise(e=>n.toBlob(e,`image/png`)),s=`physics-lotto-`+new Date().toISOString().slice(0,10)+`.png`;if(window.claude?.use)try{let e=await window.claude.use(`downloads`);if(e){try{await e.save({filename:s,data:o})}catch{}return}}catch{}let c=new File([o],s,{type:`image/png`});if(navigator.canShare&&navigator.canShare({files:[c]}))try{await navigator.share({files:[c],title:`Physics Lotto`});return}catch(e){if(e&&e.name===`AbortError`)return}let l=document.createElement(`a`);l.href=URL.createObjectURL(o),l.download=s,document.body.appendChild(l),l.click(),l.remove(),setTimeout(()=>URL.revokeObjectURL(l.href),5e3)}async function ef(e,t=!0){let n=++$.runId;$.running=!1,Z.windTarget=0,Z.suctionTarget=0,Z.gateOpen=!1,Z.floorOpen=!1,md.state.gateOpen=0,md.state.trapOpen=0,$.game=Jl(e),$.stages=Yl($.game),$.results=[],$.totalSlots=$.stages.reduce((e,t)=>e+t.pick,0),$.slotR=Math.max(...$.stages.map(e=>gd(e.max-e.min+1))),Rd($.game),Bd(),md.setSlots(Array.from({length:$.totalSlots},(e,t)=>md.slotPos(t,$.totalSlots))),Q.btnDraw.disabled=!1,$.drawDone=!1,Q.btnDraw.textContent=nu(`start`),Od(`ready`,{game:kd()}),await Promise.all([Nd(t),Pd(t)]),$.runId===n&&jd($.stages[0],t)}function tf(e){return new Promise(t=>{Z.onCapture=e=>{Z.onCapture=null,t(e)};let n=()=>{if($.runId!==e){Z.onCapture=null,t(null);return}Z.onCapture&&requestAnimationFrame(n)};requestAnimationFrame(n)})}async function nf(e,t,n){let r=e.mesh,i=Z.balls.indexOf(e);i>=0&&Z.balls.splice(i,1);let a=md.state.tubeCurve,o=e.p.clone(),s=new U,c=new kt,l=new U,u=new U,d=a.getLength();if(await Sd(Math.max(.9,d/4.2),(e,t)=>{a.getPointAt(e,l),t<.12&&l.lerp(o,1-t/.12),r.position.copy(l),a.getTangentAt(e,u),s.set(-u.z,0,u.x).normalize(),s.lengthSq()<.5&&s.set(1,0,0),c.setFromAxisAngle(s,.09),r.quaternion.premultiply(c)},wd),$.runId!==n)return;let f=md.slotPos(t,$.totalSlots);f.sub(md.drum.position);let p=r.position.clone(),m=Math.abs(p.x-f.x),h=Math.max(.4,m/3.6),g=nd/e.r,_=new U(0,0,1);if(await Sd(h,(t,n)=>{let i=Ot.lerp(p.x,f.x,t),a=i-r.position.x,o=Ot.lerp(1,g,Math.min(1,n*2.2));r.scale.setScalar(o),r.position.set(i,Ot.lerp(p.y,f.y,Math.min(1,n*2.5)),Ot.lerp(p.z,f.z,Math.min(1,n*3))),c.setFromAxisAngle(_,-a/(e.r*o)),r.quaternion.premultiply(c)},Td),$.runId!==n)return;let v=r.quaternion.clone(),y=new Tn;y.position.copy(f).add(md.drum.position),y.lookAt(md.camera.position);let b=y.quaternion.clone(),x=r.material;x.emissive=new K(`#ffffff`),md.lightSlot(t,!0),await Sd(.45,e=>{r.quaternion.slerpQuaternions(v,b,e);let t=Math.sin(e*Math.PI);r.scale.set(g*(1+t*.08),g*(1-t*.06),g*(1+t*.08)),x.emissiveIntensity=.55*(1-e)},Td),x.emissiveIntensity=0,r.scale.setScalar(g),r.position.copy(f),$.railBalls.push(r)}async function rf(e,t){Od(`swapping`,{label:ru(e.label)},`active`),Z.windTarget=0,Z.gateOpen=!1,Z.suctionTarget=0,md.state.gateOpen=0,await yd(.5),$.runId===t&&(hd.gate(),md.state.trapOpen=1,Z.floorOpen=!0,await yd(1.7),$.runId===t&&(await Nd(!1),md.state.trapOpen=0,Z.floorOpen=!1,await yd(.55),$.runId===t&&(jd(e,!0),Z.windTarget=1,hd.setAir(1),await yd(2.4))))}async function af(){if($.running)return;let e=++$.runId;$.running=!0,$.results=[],Bd(),md.setSlots(Array.from({length:$.totalSlots},(e,t)=>md.slotPos(t,$.totalSlots))),Q.btnDraw.disabled=!0,await Pd(!0),Z.balls.length===0&&jd($.stages[0],!0);let t=0;for(let n=0;n<$.stages.length;n++){let r=$.stages[n];if($.runId!==e)return;n===0?(Od(`mixing`,{},`active`),Z.windTarget=1,hd.setAir(1),await yd(3.2)):r.sameDrum||await rf(r,e);for(let i=0;i<r.pick;i++){if($.runId!==e)return;r.isMain?Od(`drawingN`,{n:i+1},`active`):r.pick>1?Od(`drawingExtraN`,{label:ru(r.label),n:i+1},`active`):Od(`drawingExtra`,{label:ru(r.label)},`active`),Z.windTarget=.85,hd.setAir(.85),Z.gateOpen=!0,md.state.gateOpen=1,Z.suctionTarget=1,hd.gate();let a=performance.now(),o=Z.suctionMax,s=setInterval(()=>{Z.suctionMax=o*(1+Math.min(2.5,(performance.now()-a)/3e3))},250),c=await tf(e);if(clearInterval(s),Z.suctionMax=o,!c||$.runId!==e||(md.state.gateOpen=0,hd.whoosh(),$.results.push({num:c.num,stageIndex:n,ball:c}),await nf(c,t,e),$.runId!==e))return;hd.land(t),Vd(n,i,c.num,r.scheme),t++,(n!==$.stages.length-1||i!==r.pick-1)&&await yd(.7)}}$.runId===e&&(Z.windTarget=0,Z.suctionTarget=0,hd.setAir(0),hd.fanfare(),Od(`done`,{game:kd()},`done`),qd(),$.running=!1,$.drawDone=!0,Q.btnDraw.disabled=!1,Q.btnDraw.textContent=nu(`again`))}eu($l()),Ad(),Id(),Fd(),Q.langSelect.addEventListener(`change`,()=>{eu(Q.langSelect.value),Ld()});function of(e){let t=e&&Gd.length>0;Q.histPanel.hidden=!t,Q.histBackdrop.hidden=!t}Q.btnHistory.addEventListener(`click`,()=>{Xd(),of(Q.histPanel.hidden)}),Q.btnHistClose.addEventListener(`click`,()=>of(!1)),Q.histBackdrop.addEventListener(`pointerdown`,()=>of(!1)),Q.histCoach.addEventListener(`click`,()=>{Xd(),of(!0)}),Q.btnSavePng.addEventListener(`click`,$d),Qd(),Q.select.addEventListener(`change`,()=>ef(Q.select.value)),Q.btnDraw.addEventListener(`click`,async()=>{if(hd.init(),hd.resume(),$.drawDone){let e=$.runId+1;if(await ef($.game.id,!0),await yd(.6),$.runId!==e)return}af()}),Q.btnReset.addEventListener(`click`,()=>{hd.setAir(0),ef($.game.id,!0)}),Q.btnSpeed.addEventListener(`click`,()=>{$.timeScale={1:2,2:3,3:5,5:1}[$.timeScale]||1,Q.btnSpeed.textContent=`${$.timeScale}×`}),Q.btnSound.addEventListener(`click`,()=>{hd.init(),$.soundOn=!$.soundOn,hd.setEnabled($.soundOn),Q.btnSound.textContent=$.soundOn?`🔊`:`🔇`}),window.addEventListener(`pointerdown`,()=>{hd.init(),hd.resume()},{once:!0}),window.addEventListener(`resize`,zd),Z.onContact=(e,t,n)=>{hd.click(t,n)},md.setWindSampler((e,t,n,r)=>Z.windVelocityAt(e,t,n,r)),window.addEventListener(`keydown`,e=>{e.code===`Space`&&!e.repeat&&document.activeElement?.tagName!==`SELECT`&&(e.preventDefault(),Q.btnDraw.click())});var sf=new Eo,cf=new Tn,lf=0,uf=1/60;function df(){requestAnimationFrame(df);try{ff()}catch(e){window.__frameErr||(window.__frameErr=String(e&&e.stack||e),console.error(`frame error`,e))}}function ff(e){let t=md.camera.position;Number.isFinite(t.x+t.y+t.z)||(t.set(.6,2.45,7.5),md.controls.target.set(0,1.28,.4),md.controls.update());let n=e??Math.min(sf.getDelta(),.05),r=n*$.timeScale;lf+=r;let i=0;for(;lf>=uf&&i<12;)Z.step(uf),lf-=uf,i++;i===12&&(lf=0);for(let e of Z.balls)e.mesh&&e.active&&(e.mesh.position.copy(e.p),e.mesh.quaternion.copy(e.q));if(Z.floorOpen)for(let e of Z.balls)e.active&&e.p.y<-.9&&(e.active=!1,Md(e));if(md.state.wind=Z.wind,$.railBalls.length){let e=1-Math.exp(-n*10);for(let t of $.railBalls)cf.position.copy(t.position).add(md.drum.position),cf.lookAt(md.camera.position),t.quaternion.slerp(cf.quaternion,e)}bd(r),Cd(r),md.update(n),(e===void 0||ff.renderForced)&&md.render()}window.__lotto={state:$,physics:Z,view:md,sfx:hd,build:fd,async run(e,t=60){let n=Math.round(e*t);for(let e=0;e<n;e++)ff(1/t),await Promise.resolve(),await Promise.resolve();ff.renderForced=!0,ff(0),ff.renderForced=!1,sf.getDelta()},render(){ff.renderForced=!0,ff(0),ff.renderForced=!1},loadGame:ef,runDraw:af,setLanguage(e){eu(e),Q.langSelect.value=tu(),Ld()}},ef(ql[0].id,!0).then(()=>{Q.loading.classList.add(`hide`)}),df();